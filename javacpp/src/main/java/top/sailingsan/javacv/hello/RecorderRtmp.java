 ...
 * @author wangsan
 */
public class RecorderRtmp {
    public static void main(String[] args) throws Exception {
        //        String inputFile = "rtmp://127.0.0.1/live/test264";
//        String inputFile = "rtsp://127.0.0.1/live/test264";
//        String inputFile = "http://127.0.0.1/live/test264.live.flv";
        String inputFile = "http://127.0.0.1/live/test264/hls.m3u8";
        // Decodes-encodes

...
public class SaveFeaturizedDataExample {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        File savedLocation = new File("/Users/wangqingpeng/git/github/hello/model.zip");      //Where to save the network. Note: the file is in .zip format - can be opened externally
